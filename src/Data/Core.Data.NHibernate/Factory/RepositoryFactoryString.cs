...
{
    public class RepositoryFactoryString : IRepositoryFactoryGeneric<string>
    {
        [Inject]
        public IKernel Kernel { get; set; }

        public IRepository<TEntity, string> GetRepository<TEntity>(IUnitOfWork untitOfWork) where TEntity : class, IDomainEntity<string>
        {
            return Kernel.Get<IRepository<TEntity, string>>(new ConstructorArgument("unitOfWork", untitOfWork));
        }
